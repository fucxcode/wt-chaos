...
declare class SavePluginContext<T extends Entity, TSession extends Session> extends PluginContext<Partial<T> | Partial<T>[] | undefined> {
    ...
    constructor(operationDescription: OperationDescription, driverName: string, collectionName: string, entityOrArray: T | T[], options?: InsertOneOptions<TSession> | InsertManyOptions<TSession> | undefined);
}
